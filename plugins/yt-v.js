...
conn.sendMessage(m.chat, { video: {url: apiytdl.descarga}, fileName: `${apiytdl.titulo}.mp4`, mimetype: 'video/mp4', caption: `Titulo: ${apiytdl.titulo}\nTamaño: ${apiytdl.peso}\nExtencion: .mp4`}, { quoted: m }).catch(e => {conn.sendButton(m.chat, `*[ ! ] Ocurrio un error inesperado u.u [ ! ]*`, `Toque el boton para usar otra alternativa`, NombreDelBot, ['[ ♻️ REINTENTAR ]', Prefijo+`ytvbochi ${text}`], m)})
} catch (e) {
