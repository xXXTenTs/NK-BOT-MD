...
export async function before(m) {
    ...
    if (room) {
        ...
        let str = `
${isWin ? `@${winner.split('@')[0]} Victoria! (+${winScore} XP)` : isTie ? `Juego terminado (+${playScore} XP)` : `Turno de (@${room.game.currentTurn.split('@')[0]}) ${['❌', '⭕'][1 * room.game._currentTurn]}`}
